...
public class JFCMainClient extends JFrame implements ActionListener, WindowListener, DocumentListener, ChangeListener, DropTargetListener {
	public static final String szVersion = "V01_20120929 by Rakesh Muppa";
	...
	static DefaultListModel dlm = null;
...
//		sCLIOptions.addOption(OptionBuilder.withDescription("FLV/WEBM format. (default: MPEG)").withLongOpt("flv").create('f'));
	...
	public static void addTextToConsole( Object o ) {
		try {
			...
			//JFCMainClient.frame.textarea.setForeground(Color.green);
	...
	public void addComponentsToPane( final Container pane ) {
		...
		JFCMainClient.dlm = new DefaultListModel();
		this.urllist = new JList( JFCMainClient.dlm );
...
//		this.userlist.setSelectionMode( ListSelectionModel.MULTIPLE_INTERVAL_SELECTION );
		...
		JFCMainClient.frame.setIconImage(createImageIcon("/images/logo.png","").getImage());
	 ...
	 * .concat(szVersion).concat(" ");//.concat("http://sourceforge.net/projects/ytd2/");
		sv = isgerman()?sv.replaceFirst("by", "von"):sv
	 */
	static void initializeUI() {
		
		String sv = "D4TY by Rakesh Muppa";
